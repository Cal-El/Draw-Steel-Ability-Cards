export const cardManifest  = [
    {
        ...
        options: [
            {
                label: "Melee Weapon Free Strike (Melee Free Strike Action)",
                value: "/cards/00-basics/01-free-strike-action_melee-weapon-free-strike.yaml",
            },
            {
                label: "Ranged Weapon Free Strike (Ranged Free Strike Action)",
    ...
    },
    {
        ...
        options: [
            {
                label: "Judgment (Censor Core Maneuver)",
                value: "/cards/04-censor/00-censor-core_judgment.yaml",
            },
            {
                label: "My Life for Yours (Censor Core Triggered Action)",
                value: "/cards/04-censor/01-censor-core_my-life-for-yours.yaml",
            },
            {
                label: "Back, Blasphemer! (Censor Signature Action)",
                value: "/cards/04-censor/02-censor-signature_back,-blasphemer!.yaml",
            },
            {
                label: "Every Step... Death! (Censor Signature Action)",
                value: "/cards/04-censor/02-censor-signature_every-step...-death!.yaml",
            },
            {
                label: "Halt, Miscreant! (Censor Signature Action)",
                value: "/cards/04-censor/02-censor-signature_halt,-miscreant!.yaml",
            },
            {
                label: "Your Allies Cannot Save You! (Censor Signature Action)",
                value: "/cards/04-censor/02-censor-signature_your-allies-cannot-save-you!.yaml",
            },
            {
                label: "Behold, a Shield of Faith! (Censor Heroic Action)",
                value: "/cards/04-censor/03-censor-heroic_behold,-a-shield-of-faith!.yaml",
            },
            {
                label: "Driving Assault (Censor Heroic Action)",
                value: "/cards/04-censor/03-censor-heroic_driving-assault.yaml",
            },
            {
                label: "The Gods Punish and Defend (Censor Heroic Action)",
                value: "/cards/04-censor/03-censor-heroic_gods-punish-and-defend.yaml",
            },
            {
                label: "Repent! (Censor Heroic Action)",
                value: "/cards/04-censor/03-censor-heroic_repent!.yaml",
            },
            {
                label: "Arrest (Censor Heroic Action)",
                value: "/cards/04-censor/04-censor-heroic_arrest.yaml",
            },
            {
                label: "Behold the Face of Evil! (Censor Heroic Action)",
                value: "/cards/04-censor/04-censor-heroic_behold-the-face-of-evil!.yaml",
            },
            {
                label: "Censored (Censor Heroic Action)",
                value: "/cards/04-censor/04-censor-heroic_censored.yaml",
            },
            {
                label: "Purifying Fire (Censor Heroic Action)",
                value: "/cards/04-censor/04-censor-heroic_purifying-fire.yaml",
            },
            {
                label: "It Is Justice You Fear (Exorcist Censor Heroic Action)",
                value: "/cards/04-censor/05-exorcist-censor-heroic_it-is-justice-you-fear.yaml",
            },
            {
                label: "Revelator (Exorcist Censor Heroic Maneuver)",
                value: "/cards/04-censor/05-exorcist-censor-heroic_revelator.yaml",
            },
            {
                label: "Prescient Grace (Oracle Censor Heroic Triggered Action)",
                value: "/cards/04-censor/05-oracle-censor-heroic_prescient-grace.yaml",
            },
            {
                label: "With My Blessing (Oracle Censor Heroic Action)",
                value: "/cards/04-censor/05-oracle-censor-heroic_with-my-blessing.yaml",
            },
            {
                label: "Blessing of the Faithful (Paragon Censor Heroic Maneuver)",
                value: "/cards/04-censor/05-paragon-censor-heroic_blessing-of-the-faithful.yaml",
            },
            {
                label: "Sentenced (Paragon Censor Heroic Action)",
                value: "/cards/04-censor/05-paragon-censor-heroic_sentenced.yaml",
            },
            {
                label: "Edict of Disruptive Isolation (Censor Heroic Maneuver)",
                value: "/cards/04-censor/06-censor-heroic_edict-of-disruptive-isolation.yaml",
            },
            {
                label: "Edict of Perfect Order (Censor Heroic Maneuver)",
                value: "/cards/04-censor/06-censor-heroic_edict-of-perfect-order.yaml",
            },
            {
                label: "Edict of Purifying Pacifism (Censor Heroic Maneuver)",
                value: "/cards/04-censor/06-censor-heroic_edict-of-purifying-pacifism.yaml",
            },
            {
                label: "Edict of Stillness (Censor Heroic Maneuver)",
                value: "/cards/04-censor/06-censor-heroic_edict-of-stillness.yaml",
            },
        ],
    },
    {
        ...
        options: [
            {
                label: "Healing Grace (Conduit Core Maneuver)",
                value: "/cards/04-conduit/00-conduit-core_healing-grace.yaml",
            },
            {
                label: "Ray of Wrath (Conduit Ranged Free Strike Action)",
                value: "/cards/04-conduit/01-conduit-ranged-free-strike-action_ray-of-wrath.yaml",
            },
            {
                label: "Word of Guidance (Conduit Triggered Action)",
                value: "/cards/04-conduit/02-conduit_word-of-guidance.yaml",
            },
            {
                label: "Word of Judgment (Conduit Triggered Action)",
                value: "/cards/04-conduit/02-conduit_word-of-judgment.yaml",
            },
            {
                label: "Bastion Ward (Conduit Ward)",
                value: "/cards/04-conduit/03-conduit-ward_bastion-ward.yaml",
            },
            {
                label: "Quickness Ward (Conduit Ward)",
                value: "/cards/04-conduit/03-conduit-ward_quickness-ward.yaml",
            },
            {
                label: "Sanctuary Ward (Conduit Ward)",
                value: "/cards/04-conduit/03-conduit-ward_sanctuary-ward.yaml",
            },
            {
                label: "Spirit Ward (Conduit Ward)",
                value: "/cards/04-conduit/03-conduit-ward_spirit-ward.yaml",
            },
            {
                label: "Blessed Light (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_blessed-light.yaml",
            },
            {
                label: "Drain (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_drain.yaml",
            },
            {
                label: "Holy Lash (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_holy-lash.yaml",
            },
            {
                label: "Lightfall (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_lightfall.yaml",
            },
            {
                label: "Sacrificial Offer (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_sacrificial-offer.yaml",
            },
            {
                label: "Staggering Curse (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_staggering-curse.yaml",
            },
            {
                label: "Warrior's Prayer (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_warrior's-prayer.yaml",
            },
            {
                label: "Wither (Conduit Signature Action)",
                value: "/cards/04-conduit/04-conduit-signature-action_wither.yaml",
            },
            {
                label: "Call the Thunder Down (Conduit Heroic Action)",
                value: "/cards/04-conduit/05-conduit-heroic-action_call-the-thunder-down.yaml",
            },
            {
                label: "Font of Wrath (Conduit Heroic Action)",
                value: "/cards/04-conduit/05-conduit-heroic-action_font-of-wrath.yaml",
            },
            {
                label: "Judgment's Hammer (Conduit Heroic Action)",
                value: "/cards/04-conduit/05-conduit-heroic-action_judgment's-hammer.yaml",
            },
            {
                label: "Violence will not Aid Thee (Conduit Heroic Action)",
                value: "/cards/04-conduit/05-conduit-heroic-action_violence-will-not-aid-thee.yaml",
            },
            {
                label: "Corruption's Curse (Conduit Heroic Action)",
                value: "/cards/04-conduit/06-conduit-heroic_corruption's-curse.yaml",
            },
            {
                label: "Curse of Terror (Conduit Heroic Action)",
                value: "/cards/04-conduit/06-conduit-heroic_curse-of-terror.yaml",
            },
            {
                label: "Faith is Our Armor (Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/06-conduit-heroic_faith-is-our-armor.yaml",
            },
            {
                label: "Sermon of Grace (Conduit Heroic Action)",
                value: "/cards/04-conduit/06-conduit-heroic_sermon-of-grace.yaml",
            },
            {
                label: "Blessing of Fate and Destiny (Fate Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_blessing-of-fate-and-destiny.yaml",
            },
            {
                label: "Blessing of Insight (War Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_blessing-of-insight.yaml",
            },
            {
                label: "Divine Comedy (Trickery Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_divine-comedy.yaml",
            },
            {
                label: "The Gods Command, You Obey (Knowledge Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_gods-command,-you-obey.yaml",
            },
            {
                label: "Morning Light (Sun Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_morning-light.yaml",
            },
            {
                label: "Nature Judges Thee (Nature Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_nature-judges-thee.yaml",
            },
            {
                label: "Our Hearts, Your Strength (Love Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_our-hearts,-your-strength.yaml",
            },
            {
                label: "Reap (Death Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_reap.yaml",
            },
            {
                label: "Sacred Bond (Protection Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_sacred-bond.yaml",
            },
            {
                label: "Saint's Tempest (Storm Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_saint's-tempest.yaml",
            },
            {
                label: "Statue of Power (Creation Domain Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_statue-of-power.yaml",
            },
            {
                label: "Wellspring of Grace (Life Domain Conduit Heroic Action)",
                value: "/cards/04-conduit/07-domain-conduit-heroic_wellspring-of-grace.yaml",
            },
            {
                label: "Fear of the Gods (Conduit Heroic Action)",
                value: "/cards/04-conduit/08-conduit-heroic_fear-of-the-gods.yaml",
            },
            {
                label: "Saint's Raiment (Conduit Heroic Maneuver)",
                value: "/cards/04-conduit/08-conduit-heroic_saint's-raiment.yaml",
            },
            {
                label: "Soul Siphon (Conduit Heroic Action)",
                value: "/cards/04-conduit/08-conduit-heroic_soul-siphon.yaml",
            },
            {
                label: "Words of Wrath and Grace (Conduit Heroic Action)",
    ...
    },
    {
        ...
        options: [
            {
                label: "Arcane Trick (Supernatural Perk Action)",
                value: "/cards/06-perks/supernatural-perk_arcane-trick.yaml",
            },
            {
                label: "Invisible Force (Supernatural Perk Maneuver)",
                value: "/cards/06-perks/supernatural-perk_invisible-force.yaml",
            },
            {
                label: "Psychic Whisper (Supernatural Perk Maneuver)",
    ...
    },
    {
        ...
        options: [
            {
                label: "Come Out to Play (Ratcatcher Title Maneuver)",
                value: "/cards/09-titles/ratcatcher-title-maneuver_come-out-to-play.yaml",
            },
            {
                label: "Holy Terror (Zombie Slayer Title Maneuver)",
    ...
    },
    {
        ...
        options: [
            {
                label: "Faithful Friend (Domain Feature Action)",
                value: "/cards/99-misc/domain-feature-action_faithful-friend.yaml",
            },
            {
                label: "Grave Speech (Domain Feature Action)",
                value: "/cards/99-misc/domain-feature-action_grave-speech.yaml",
            },
            {
                label: "Hands of the Maker (Domain Feature Maneuver)",
                value: "/cards/99-misc/domain-feature-maneuver_hands-of-the-maker.yaml",
            },
        ],
    },
]
