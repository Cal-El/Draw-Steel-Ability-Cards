      ...
      <div className="p-4 w-full max-w-md place-self-center">
        <div className="relative p-4 text-center rounded-lg shadow bg-zinc-100 flex flex-col items-center border-[3pt] border-zinc-600">
            ...
            <div className="flex justify-center items-center space-x-4">
                <button type="button" onClick={onCancel} className="py-2 px-3 text-sm font-medium text-cardback bg-[#323842] hover:brightness-90 rounded-lg border border-gray-20 focus:ring-4 focus:outline-none focus:ring-primary-300 focus:z-30">
                    Cancel
                </button>
