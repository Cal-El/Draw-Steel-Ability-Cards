    ...
    return (
        <div className={`flex`}>
            ...
            <div className={`w-[325.5pt]`}>
                <div className={`h-[3pt]`}/>
                <div className={`${card.hasCost ? 'w-[285.5pt]' : 'w-[325.5pt]'} h-[15pt]`}>
                ...
                <div className={`${card.hasCost ? 'w-[285.5pt]' : 'w-[325.5pt]'} h-[21pt]`}>
                    <h1 className={`${card.hasCost ? 'w-[285.5pt]' : 'w-[325.5pt]'} text-[24pt] font-display font-bold small-caps ${actionTextColorStyle[card.type]} leading-[19.5pt]`}><AutoTextSize maxFontSizePx={32}>{card.title}</AutoTextSize></h1>
                </div>
