...
export default function TargetBox({card, bgColorGetter, children}: {card: ability_card, bgColorGetter: (t: string, s: ColourSet) => string, children?: JSX.Element | JSX.Element[]}){
