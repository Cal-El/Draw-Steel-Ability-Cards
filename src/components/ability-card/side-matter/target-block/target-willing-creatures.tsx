...
export default function TargetWillingCreatures({card, bgColorGetter, numCreatures}: {card: ability_card, bgColorGetter: (t: string, s: ColourSet) => string, numCreatures: string}){
    return (
