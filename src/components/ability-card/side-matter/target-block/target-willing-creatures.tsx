...
export default function TargetWillingCreatures({card, bgColorGetter, numCreatures}: {card: ability_card, bgColorGetter: (t: string, s: ColourSet, b: ColourSet) => string, numCreatures: string}){
    return (
