...
export default function TargetCreaturesOrObjects({card, bgColorGetter, numCreatures}: {card: ability_card, bgColorGetter: (t: string, s: ColourSet) => string, numCreatures: string}){
    return (
